...
第<input type="number" required="required" name="page" style="width:4em" value="${page}">页
...
<a onclick="loadPageQuestion(${page}, 'createtime desc')">日期</a>&nbsp;
<a onclick="loadPageQuestion(${page}, 'click desc')">点击量</a>
</form>
<div>
<hr/>
</div>
