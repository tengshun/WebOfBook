...
<div class="all">
	...
	<div class="content">	
		...
		<div class="navigation">
			<ul>
			<li><a href="loadQuestion?isbn=${book.isbn}&order=createtime desc" target="display">问答</a></li>
			<li><a href="#">资料</a></li>
			<li><a href="#">书评</a></li>
			<li><a href="#">我的笔记</a></li>
			<li><a href="#">购买此书</a></li>
		...
		<iframe name="display" seamless="seamless" height="1000px" width="100%" src="loadQuestion?isbn=${book.isbn}&order=createtime desc"></iframe>
		</div>	
	</div>
